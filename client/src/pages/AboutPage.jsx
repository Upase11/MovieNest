...
const AboutPage = () => {
  return (
    <Container maxWidth="md" sx={{ margin: "0 auto", maxWidth: "800px" }}>
      ...
      M⭕VIEℕEST a wide range of content for users to browse, search, and enjoy their
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Typography variant="body1">
          The M⭕VIEℕEST project is open to contributions. If you would like to
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Typography variant="body1">
          We hope you enjoy using M⭕VIEℕEST for your movie and TV show
